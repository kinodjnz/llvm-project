...
#define _LIBUNWIND_HIGHEST_DWARF_REGISTER_CRAMP     64
...
#  define _LIBUNWIND_TARGET_CRAMP 1
#  if defined(__cramp_flen)
#   define CRAMP_FLEN __cramp_flen
#  else
#   define CRAMP_FLEN 0
#  endif
#  define _LIBUNWIND_CONTEXT_SIZE (32 * (__cramp_xlen + CRAMP_FLEN) / 64)
#  if __cramp_xlen == 32
#   define _LIBUNWIND_CURSOR_SIZE (_LIBUNWIND_CONTEXT_SIZE + 7)
#  elif __cramp_xlen == 64
#   define _LIBUNWIND_CURSOR_SIZE (_LIBUNWIND_CONTEXT_SIZE + 12)
#  else
#   error "Unsupported Cramp ABI"
#  endif
# define _LIBUNWIND_HIGHEST_DWARF_REGISTER _LIBUNWIND_HIGHEST_DWARF_REGISTER_CRAMP
# elif defined(__ve__)
