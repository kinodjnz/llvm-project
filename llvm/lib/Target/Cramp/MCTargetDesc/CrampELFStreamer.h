//===-- CrampELFStreamer.h - Cramp ELF Target Streamer ---------*- C++ -*--===//
//
...
#ifndef LLVM_LIB_TARGET_Cramp_MCTARGETDESC_CrampELFSTREAMER_H
#define LLVM_LIB_TARGET_Cramp_MCTARGETDESC_CrampELFSTREAMER_H
...
class CrampTargetELFStreamer : public CrampTargetStreamer {
private:
...
public:
  ...
  CrampTargetELFStreamer(MCStreamer &S, const MCSubtargetInfo &STI);
