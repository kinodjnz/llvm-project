//===-- CrampInstrInfo.h - Cramp Instruction Information --------*- C++ -*-===//
//
...
#ifndef LLVM_LIB_TARGET_Cramp_CrampINSTRINFO_H
#define LLVM_LIB_TARGET_Cramp_CrampINSTRINFO_H
...
} // end of namespace CrampCC

class CrampInstrInfo : public CrampGenInstrInfo {

public:
  explicit CrampInstrInfo(CrampSubtarget &STI);

  MCInst getNop() const override;
  const MCInstrDesc &getBrCond(CrampCC::CondCode CC) const;
...
// Implemented in CrampGenInstrInfo.inc
...
#define GET_CrampVPseudosTable_DECL
#include "CrampGenSearchableTables.inc"

} // end namespace CrampVPseudosTable
