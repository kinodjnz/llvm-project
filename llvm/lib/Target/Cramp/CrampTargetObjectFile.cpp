//===-- CrampTargetObjectFile.cpp - Cramp Object Info -----------------===//
//
...
void CrampELFTargetObjectFile::Initialize(MCContext &Ctx,
...
bool CrampELFTargetObjectFile::isInSmallSection(uint64_t Size) const {
...
// section.
bool CrampELFTargetObjectFile::isGlobalInSmallSection(
...
MCSection *CrampELFTargetObjectFile::SelectSectionForGlobal(
...
void CrampELFTargetObjectFile::getModuleMetadata(Module &M) {
...
bool CrampELFTargetObjectFile::isConstantInSmallSection(
    const DataLayout &DL, const Constant *CN) const {
  return isInSmallSection(DL.getTypeAllocSize(CN->getType()));
}

MCSection *CrampELFTargetObjectFile::getSectionForConstant(
