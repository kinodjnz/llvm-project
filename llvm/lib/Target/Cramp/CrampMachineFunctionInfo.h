//=- CrampMachineFunctionInfo.h - Cramp machine function info -----*- C++ -*-=//
//
...
#ifndef LLVM_LIB_TARGET_Cramp_CrampMACHINEFUNCTIONINFO_H
#define LLVM_LIB_TARGET_Cramp_CrampMACHINEFUNCTIONINFO_H
...
class CrampMachineFunctionInfo;

namespace yaml {
struct CrampMachineFunctionInfo final : public yaml::MachineFunctionInfo {
  int VarArgsFrameIndex;
  int VarArgsSaveSize;

  CrampMachineFunctionInfo() = default;
  CrampMachineFunctionInfo(const llvm::CrampMachineFunctionInfo &MFI);

  void mappingImpl(yaml::IO &YamlIO) override;
  ~CrampMachineFunctionInfo() = default;
};

template <> struct MappingTraits<CrampMachineFunctionInfo> {
  static void mapping(IO &YamlIO, CrampMachineFunctionInfo &MFI) {
...
/// CrampMachineFunctionInfo - This class is derived from MachineFunctionInfo
/// and contains private Cramp-specific information for each MachineFunction.
class CrampMachineFunctionInfo : public MachineFunctionInfo {
private:
...
public:
  CrampMachineFunctionInfo(const MachineFunction &MF) {}
  ...
  bool useSaveRestoreLibCalls(const MachineFunction &MF) const {
    ...
    return MF.getSubtarget<CrampSubtarget>().enableSaveRestore() &&
  ...
  void initializeBaseYamlFields(const yaml::CrampMachineFunctionInfo &YamlMFI);
};

} // end namespace llvm

#endif // LLVM_LIB_TARGET_Cramp_CrampMACHINEFUNCTIONINFO_H
