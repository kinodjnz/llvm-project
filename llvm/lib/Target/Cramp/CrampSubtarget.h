//===-- CrampSubtarget.h - Define Subtarget for the Cramp -------*- C++ -*-===//
//
...
//===----------------------------------------------------------------------===//
//
// This file declares the Cramp specific subclass of TargetSubtargetInfo.
//
//===----------------------------------------------------------------------===//

#ifndef LLVM_LIB_TARGET_Cramp_CrampSUBTARGET_H
#define LLVM_LIB_TARGET_Cramp_CrampSUBTARGET_H
...
class CrampSubtarget : public CrampGenSubtargetInfo {
public:
...
private:
  ...
  CrampProcFamilyEnum CrampProcFamily = Others;
  ...
  CrampFrameLowering FrameLowering;
  ...
  CrampSubtarget &initializeSubtargetDependencies(const Triple &TT,
                                                  StringRef CPU,
                                                  StringRef TuneCPU,
                                                  StringRef FS,
                                                  StringRef ABIName);
...
public:
  ...
  CrampSubtarget(const Triple &TT, StringRef CPU, StringRef TuneCPU,
  ...
  const CrampFrameLowering *getFrameLowering() const override {
    return &FrameLowering;
  }
  const CrampInstrInfo *getInstrInfo() const override { return &InstrInfo; }
  const CrampRegisterInfo *getRegisterInfo() const override {
    return &RegInfo;
  }
  const CrampTargetLowering *getTargetLowering() const override {
    return &TLInfo;
  }
  ...
  /// Returns Cramp processor family.
  /// Avoid this function! CPU specifics should be kept local to this class
  /// and preferably modeled with SubtargetFeatures or properties in
  /// initializeProperties().
  CrampProcFamilyEnum getProcFamily() const { return CrampProcFamily; }
  ...
  bool isRegisterReservedByUser(Register i) const {
    assert(i < Cramp::NUM_TARGET_REGS && "Register out of range");
