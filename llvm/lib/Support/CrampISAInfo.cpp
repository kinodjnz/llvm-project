//===-- CrampISAInfo.cpp - Cramp Arch String Parser --------------===//
//
...
struct CrampExtensionVersion {
  unsigned Major;
  unsigned Minor;
};

struct CrampSupportedExtension {
  const char *Name;
  /// Supported version.
  CrampExtensionVersion Version;
};
...
static const CrampSupportedExtension SupportedExtensions[] = {
    {"i", CrampExtensionVersion{2, 0}},
    {"e", CrampExtensionVersion{1, 9}},
    {"m", CrampExtensionVersion{2, 0}},
    {"a", CrampExtensionVersion{2, 0}},
    {"f", CrampExtensionVersion{2, 0}},
    {"d", CrampExtensionVersion{2, 0}},
    {"c", CrampExtensionVersion{2, 0}},

    {"zihintpause", CrampExtensionVersion{2, 0}},

    {"zfhmin", CrampExtensionVersion{1, 0}},
    {"zfh", CrampExtensionVersion{1, 0}},

    {"zfinx", CrampExtensionVersion{1, 0}},
    {"zdinx", CrampExtensionVersion{1, 0}},
    {"zhinxmin", CrampExtensionVersion{1, 0}},
    {"zhinx", CrampExtensionVersion{1, 0}},

    {"zba", CrampExtensionVersion{1, 0}},
    {"zbb", CrampExtensionVersion{1, 0}},
    {"zbc", CrampExtensionVersion{1, 0}},
    {"zbs", CrampExtensionVersion{1, 0}},

    {"zbkb", CrampExtensionVersion{1, 0}},
    {"zbkc", CrampExtensionVersion{1, 0}},
    {"zbkx", CrampExtensionVersion{1, 0}},
    {"zknd", CrampExtensionVersion{1, 0}},
    {"zkne", CrampExtensionVersion{1, 0}},
    {"zknh", CrampExtensionVersion{1, 0}},
    {"zksed", CrampExtensionVersion{1, 0}},
    {"zksh", CrampExtensionVersion{1, 0}},
    {"zkr", CrampExtensionVersion{1, 0}},
    {"zkn", CrampExtensionVersion{1, 0}},
    {"zks", CrampExtensionVersion{1, 0}},
    {"zkt", CrampExtensionVersion{1, 0}},
    {"zk", CrampExtensionVersion{1, 0}},

    {"zmmul", CrampExtensionVersion{1, 0}},

    {"v", CrampExtensionVersion{1, 0}},
    {"zvl32b", CrampExtensionVersion{1, 0}},
    {"zvl64b", CrampExtensionVersion{1, 0}},
    {"zvl128b", CrampExtensionVersion{1, 0}},
    {"zvl256b", CrampExtensionVersion{1, 0}},
    {"zvl512b", CrampExtensionVersion{1, 0}},
    {"zvl1024b", CrampExtensionVersion{1, 0}},
    {"zvl2048b", CrampExtensionVersion{1, 0}},
    {"zvl4096b", CrampExtensionVersion{1, 0}},
    {"zvl8192b", CrampExtensionVersion{1, 0}},
    {"zvl16384b", CrampExtensionVersion{1, 0}},
    {"zvl32768b", CrampExtensionVersion{1, 0}},
    {"zvl65536b", CrampExtensionVersion{1, 0}},
    {"zve32x", CrampExtensionVersion{1, 0}},
    {"zve32f", CrampExtensionVersion{1, 0}},
    {"zve64x", CrampExtensionVersion{1, 0}},
    {"zve64f", CrampExtensionVersion{1, 0}},
    {"zve64d", CrampExtensionVersion{1, 0}},

    {"zicbom", CrampExtensionVersion{1, 0}},
    {"zicboz", CrampExtensionVersion{1, 0}},
    {"zicbop", CrampExtensionVersion{1, 0}},
};

static const CrampSupportedExtension SupportedExperimentalExtensions[] = {
    {"zbe", CrampExtensionVersion{0, 93}},
    {"zbf", CrampExtensionVersion{0, 93}},
    {"zbm", CrampExtensionVersion{0, 93}},
    {"zbp", CrampExtensionVersion{0, 93}},
    {"zbr", CrampExtensionVersion{0, 93}},
    {"zbt", CrampExtensionVersion{0, 93}},
    {"zvfh", CrampExtensionVersion{0, 1}},
};
...
struct FindByName {
  ...
  StringRef Ext;
  bool operator()(const CrampSupportedExtension &ExtInfo) {
    return ExtInfo.Name == Ext;
  }
};

static Optional<CrampExtensionVersion> findDefaultVersion(StringRef ExtName) {
...
void CrampISAInfo::addExtension(StringRef ExtName, unsigned MajorVersion,
                                unsigned MinorVersion) {
  CrampExtensionInfo Ext;
...
static Optional<CrampExtensionVersion> isExperimentalExtension(StringRef Ext) {
  auto ExtIterator =
...
bool CrampISAInfo::isSupportedExtensionFeature(StringRef Ext) {
...
bool CrampISAInfo::isSupportedExtension(StringRef Ext) {
  return llvm::any_of(SupportedExtensions, FindByName(Ext)) ||
         llvm::any_of(SupportedExperimentalExtensions, FindByName(Ext));
}

bool CrampISAInfo::isSupportedExtension(StringRef Ext, unsigned MajorVersion,
                                        unsigned MinorVersion) {
  auto FindByNameAndVersion = [=](const CrampSupportedExtension &ExtInfo) {
...
bool CrampISAInfo::hasExtension(StringRef Ext) const {
...
bool CrampISAInfo::compareExtension(const std::string &LHS,
...
static Error getExtensionVersion(StringRef Ext, StringRef In, unsigned &Major,
  ...
  if (CrampISAInfo::isSupportedExtension(Ext, Major, Minor))
    return Error::success();
...
CrampISAInfo::parseFeatures(unsigned XLen,
                            const std::vector<std::string> &Features) {
  assert(XLen == 32 || XLen == 64);
  std::unique_ptr<CrampISAInfo> ISAInfo(new CrampISAInfo(XLen));
  ...
  return CrampISAInfo::postProcessAndChecking(std::move(ISAInfo));
}

llvm::Expected<std::unique_ptr<CrampISAInfo>>
CrampISAInfo::parseArchString(StringRef Arch, bool EnableExperimentalExtension,
                              bool ExperimentalExtensionVersionCheck) {
...
Error CrampISAInfo::checkDependency() {
  bool IsRv32 = XLen == 32;
...
void CrampISAInfo::updateImplication() {
  bool HasE = Exts.count("e") != 0;
...
void CrampISAInfo::updateCombination() {
...
void CrampISAInfo::updateMinVLen() {
  for (auto const &Ext : Exts) {
    StringRef ExtName = Ext.first;
...
void CrampISAInfo::updateMaxELen() {
...
std::string CrampISAInfo::toString() const {
  std::string Buffer;
...
std::vector<std::string> CrampISAInfo::toFeatureVector() const {
...
llvm::Expected<std::unique_ptr<CrampISAInfo>>
CrampISAInfo::postProcessAndChecking(std::unique_ptr<CrampISAInfo> &&ISAInfo) {
...
StringRef CrampISAInfo::computeDefaultABI() const {
  if (XLen == 32) {
    if (hasExtension("d"))
      return "ilp32d";
    if (hasExtension("e"))
