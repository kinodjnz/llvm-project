//===-- CrampAttributes.cpp - Cramp Attributes ----------------------------===//
//
...
using namespace llvm::CrampAttrs;
...
constexpr TagNameMap CrampAttributeTags{tagData};
const TagNameMap &llvm::CrampAttrs::getCrampAttributeTags() {
  return CrampAttributeTags;
}
